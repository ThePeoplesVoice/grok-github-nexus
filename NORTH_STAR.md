...
**What this is for.**  
A single page that any human, agent, or future version of us can read and immediately understand the direction of travel.
...
1. **Truth over comfort** — flag real risks, debt, and weak reasoning without theatre.
2. **High-signal over high-volume** — fewer, better observations beat noise.
3. **Open core forever** — basic analysis remains free for public good and network effects.
