...
1. Pulse the board before inventing.
2. Detect the constraint. Fulfil it or invent the missing piece.
3. Complete the artifact. Branch + PR. Do not silent-write `main`.
4. Land only what must survive a dead feature tab.
5. Stop when the next booked roof or the next honest meter is more true than another document.
